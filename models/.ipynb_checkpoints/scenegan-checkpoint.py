...
class Encoder(nn.Module):
    def __init__(self, args, blur_kernel=[1, 3, 3, 1]):
        ...
        self.convs1 = ConvLayer(3+151+1, channels[args.prior_size], 1)
        ...
        for i in range(log_size, 2, -1):
            ...
            if 4 <= out_size//2 <= args.starting_feature_size: # cropped center is needed feature, thus why //2
    ...
    def forward(self, input):
        ...
        for conv in self.convs2:
            ...
            if 4 <= cropped_feature_size <= self.args.starting_feature_size:
