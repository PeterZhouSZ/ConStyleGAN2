...
"""
This is unsupervised stylegan training, this is compatible with scenegan_trainer.py
This is used to verify if scenegan_trainer is correct 
"""
...
class Generator(nn.Module):
    def __init__(self, args, channel_multiplier=2, blur_kernel=[1, 3, 3, 1], lr_mlp=0.01, ):
        ...
        print('This is a regular stylegan, which is used to verify if trainer implemented correctly')
    ...
    def forward(self, global_pri, styles=None, return_latents=False, inject_index=None, truncation=1, truncation_latent=None, input_type=None, noise=None, randomize_noise=True, return_loss=True):
        ...
        """
        input_type = 'z'
        styles = [ torch.rand(  self.args.batch_size, 512 ).cuda()  ]
        ...
        output = { 'image':image, 'latent':latent, 'klloss':torch.tensor([0]).cuda()  }
